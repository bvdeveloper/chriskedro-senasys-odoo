...
class ProductTemplate(models.Model):
    ...
    oem_part_number = fields.Text(string="OEM Part Number")
    ...
    inv_location = fields.Selection(
        [('TBD', 'TBD'), ('1A', '1A'), ('1B', '1B'), ('1C', '1C'), ('1D', '1D'), ('1E', '1E'), ('2A', '2A'),
         ...
         ('MACHINE SHOP', 'M.SHOP-1'), ('M.SHOP-2', 'M.SHOP-2'),('Zero', 'M.SHOP-3'), ('GLUE-?', 'M.SHOP-4'),
         ('M.SHOP-5', 'M.SHOP-5'), ('OTHER', 'OTHER'), ('GLUE-B', 'GLUE-B'), ('GLUE-R', 'GLUE-R'), ('GLUE-Y', 'GLUE-Y'),
         ('Rack 1A', 'Rack 1'), ('Rack 1B', 'Rack 2'), ('Rack 1C', 'Rack 3'), ('Rack 1D', 'Rack 4'), ('Rack 5', 'Rack 5'),
         ('Rack 6', 'Rack 6')]
        , string='Inv Location:')
